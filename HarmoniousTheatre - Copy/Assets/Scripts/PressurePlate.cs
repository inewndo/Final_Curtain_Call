...
public class PressurePlate : MonoBehaviour
{
    ...
    HashSet<PhysiscsObj> countedObjects = new HashSet<PhysiscsObj>();
    HashSet<PhysiscsObj> objectsOnPlate = new HashSet<PhysiscsObj>();
    ...
    {
        PhysiscsObj physObj = other.GetComponent<PhysiscsObj>();
